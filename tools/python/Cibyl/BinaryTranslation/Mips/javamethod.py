...
class JavaMethod(CodeBlock):
    ...
    def __init__(self, controller, functions):
        ...
        for fn in self.functions:
            ...
            for key, item in fn.labels.items():
    ...
    def fixup(self):
        ...
        for insn in self.instructions:
            ...
            if isinstance(insn, instruction.Jal) and insn.dstAddress not in [fn.address for fn in self.functions]:
    ...
    def compile(self):
        ...
        for fn in self.functions:
            for reg, local in registerMapping[fn.address].items():
        ...
        for reg in self.cleanupRegs:
            ...
            for fn in self.functions:
                ...
                if reg in mapping and not register.regIsStatic(reg):
        ...
        if self.hasMultipleFunctions():
            ...
            table = []
            for address, key in self.returnAddresses.items():
